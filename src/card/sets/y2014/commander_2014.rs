...
pub(in crate::card::sets) static TEFERI_TEMPORAL_ARCHMAGE: CardRecord = CardRecord::new(
    "Teferi, Temporal Archmage",
    "80eec0bd-9eb4-4360-b97b-9c7985a63343",
    "Tyler Jacobson",
    CardRules::new_planeswalker(mana_cost!("{4}{U}{U}"), &["Teferi"], 5)
        .with_supertype(CardSupertype::Legendary)
        .with_abilities(&[
            AbilityDef::activated(
            ...
            AbilityDef::deck_construction(
                ...
                "Commander designation is chosen before the game.",
            ),
        ]),
);

// C14 33 — Daretti, Scrap Savant
pub(in crate::card::sets) static DARETTI_SCRAP_SAVANT: CardRecord = CardRecord::new(
    "Daretti, Scrap Savant",
    "cda40e31-ba99-4565-ad92-7c687ff44bd9",
    "Dan Murayama Scott",
    CardRules::new_planeswalker(mana_cost!("{3}{R}"), &["Daretti"], 3)
        .with_supertype(CardSupertype::Legendary)
        .with_abilities(&[
            AbilityDef::activated(
                ...
                EffectDef::Choose(ChooseDef {
                    ...
                    then: &EffectDef::Sequence(&[
                        ...
                        abilities::draw_cards(ValueDef::BoundObjectCount(Binding!(
                            "daretti_discards"
                        ))),
                    ]),
                }),
                    ...
                    emblem: EmblemCharacteristics::new(
                        ...
                        &[AbilityDef::triggered(
                            ...
                            EffectDef::BindObjects(BindObjectsDef {
                                ...
                                binding: Binding!("daretti_return"),
            ...
            AbilityDef::deck_construction(
                ...
                DeckConstructionDef::MayBeCommander,
                "Commander designation is chosen before the \
                 game.",
            ),
        ]),
);
...
pub(in crate::card::sets) static DUALCASTER_MAGE: CardRecord = CardRecord::new(
    "Dualcaster Mage",
...
pub(in crate::card::sets) static TITANIA_PROTECTOR_OF_ARGOTH: CardRecord = CardRecord::new(
    ...
    CardRules::new_creature(mana_cost!("{3}{G}{G}"), &["Elemental"], 5, 3)
        ...
        .with_abilities(&[
            abilities::enters_trigger_with_targets(
                "When Titania enters, return target land card from your \
            ...
            AbilityDef::triggered(
                "Whenever a land you control is put into a graveyard from \
                 the battlefield, create a 5/3 green Elemental creature \
                 token.",
                TriggerEventDef::zone_changed(
                ...
                EffectDef::CreateToken(CreateTokenDef::new(TokenDef::Literal(
                    TokenCharacteristics::creature(&["Elemental"], &[ManaColor::Green], 5, 3)
                        .with_art(CardArt::new(
                            "27440269-3b09-4010-8401-f159dc49a4cd",
                            "Nils Hamm",
                        )),
                ))),
            ),
