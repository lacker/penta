...
fn any_target_damage_can_remove_a_planeswalker() {
    let definition_id = CardDefinitionId::from_uuid("00000000-0000-0000-0000-00000000275b");
...
fn simultaneous_exits_keep_pre_exit_characteristics_for_trigger_matching() {
    static ABILITIES: [AbilityDef; 1] = [AbilityDef::triggered(
        ...
        TriggerEventDef::zone_changed(
            ObjectPredicateDef::Subtype(crate::card::SubtypeDef::from_name("Mountain")),
            Some(ZoneKind::Battlefield),
            Some(ZoneKind::Graveyard),
        ),
        EffectDef::GainLife {
    ...
    let definition_id = CardDefinitionId::from_uuid("00000000-0000-0000-0000-000000002761");
    let mut definition = CardDefinition::new(
        definition_id,
