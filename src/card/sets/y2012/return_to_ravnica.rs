...
use crate::card::{
    ...
    AppliedRuleDef, BasicLandType, BattlefieldEntryModificationDef, BindObjectsDef, CardArt,
    CardNameDef, CardRules, CardSet, CardSupertype, CardType, CardTypeSet, CastTimingPermissionDef,
    ...
    ZoneKind, ZoneMoveCauseDef, ZonePlacement, abilities, actions,
};
    ...
    CardRules::new_artifact_creature(mana_cost!("{4}"), &["Construct"], 4, 4).with_abilities(&[
        ...
        AbilityDef::triggered(
            ...
            EffectDef::FlipCoin {
                ...
                on_loss: &actions::sacrifice(EffectRecipientDef::Source).as_effect(),
            },
        ),
        abilities::dies_trigger(
