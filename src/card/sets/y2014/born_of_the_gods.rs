...
pub(in crate::card::sets) static SPIRIT_OF_THE_LABYRINTH: CardRecord = CardRecord::new(
...
pub(in crate::card::sets) static RETRACTION_HELIX: CardRecord = CardRecord::new(
    "Retraction Helix",
    "4fe8c0b9-fdf4-4fc0-aa7c-774546cdd792",
    "Phill Simmer",
    CardRules::new_instant(mana_cost!("{U}")).with_abilities(&[AbilityDef::spell_with_targets(
        "Until end of turn, target creature gains \"{T}: Return \
...
// BNG 61 — Bile Blight
pub(in crate::card::sets) static BILE_BLIGHT: CardRecord = CardRecord::new(
    "Bile Blight",
    "3ca11057-e50a-4817-924a-5bb504d0780f",
    "Vincent Proce",
    CardRules::new_instant(mana_cost!("{B}{B}")).with_abilities(&[AbilityDef::spell_with_targets(
        "Target creature and all other creatures with the same name \
         as that creature get -3/-3 until end of turn.",
        &[AbilityTargetDef::exactly_one_permanent(
            ObjectPredicateDef::HasType(CardType::Creature),
        )],
        EffectDef::Apply {
...
pub(in crate::card::sets) static ASTRAL_CORNUCOPIA: CardRecord = CardRecord::new(
    "Astral Cornucopia",
    ...
    CardRules::new_artifact(mana_cost!("{5}"))
        ...
        .with_abilities(&[
            ...
            AbilityDef::activated(
                "{X}, {T}: Look at the top X cards of your library. You may \
                 reveal a legendary creature card from among them and put it \
