...
pub(in crate::card::sets) static MACHINE_GOD_S_EFFIGY: CardRecord = CardRecord::new(
...
pub(in crate::card::sets) static URZA_S_WORKSHOP: CardRecord = CardRecord::new(
    "Urza's Workshop",
...
pub(in crate::card::sets) static CARDS: &[&CardRecord] = &[&MACHINE_GOD_S_EFFIGY, &URZA_S_WORKSHOP];
