...
pub(in crate::card::sets) static BALOTH_PRIME: CardRecord = CardRecord::new(
    ...
    CardRules::new_creature(mana_cost!("{3}{G}"), &["Beast"], 10, 10).with_abilities(&[
        AbilityDef::as_enters(
            "This creature enters tapped with six stun counters on it. \
        ...
        AbilityDef::triggered(
            "Whenever you sacrifice a land, create a tapped 4/4 green \
             Beast creature token and untap this creature.",
...
pub(in crate::card::sets) static SURGE_CONDUCTOR: CardRecord = CardRecord::new(
    "Surge Conductor",
...
pub(in crate::card::sets) static EUMIDIAN_HATCHERY: CardRecord = CardRecord::new(
    "Eumidian Hatchery",
...
pub(in crate::card::sets) static RADIANT_SUMMIT: CardRecord = CardRecord::new(
    "Radiant Summit",
