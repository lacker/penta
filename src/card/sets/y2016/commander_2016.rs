...
abilities::trample(),
AbilityDef::triggered("Whenever Tana deals combat damage to a player, create that many 1/1 green Saproling creature tokens.", TriggerEventDef::combat_damage_to_player(ObjectPredicateDef::Source), EffectDef::create_creature_token(&["Saproling"], &[ManaColor::Green], 1, 1).with_count(ValueDef::TriggerEventAmount)),
