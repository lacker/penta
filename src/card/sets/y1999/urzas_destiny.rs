...
use crate::card::{
    ...
    AppliedRuleDef, ArrivalAttachmentDef, BasicLandType, BattlefieldArrivalDef,
    BattlefieldEntryChoiceDestinationDef, BattlefieldEntryScalarChoiceDef, CardArt, CardNameDef,
