...
pub(in crate::card::sets) static CLOAK_AND_DAGGER_ENTWINED: CardRecord = CardRecord::new(
    ...
    CardRules::new_creature(mana_cost!("{1}{W}{B}"), &["Human", "Hero"], 2, 2)
        ...
        .with_abilities(&[
            ...
            abilities::lifelink(),
            abilities::enters_trigger_with_targets(
                "When Cloak and Dagger enter, choose target opponent and up to one \
                target creature they control. They reveal their hand. You may exile a \
                nonland card from their hand or the chosen creature until Cloak and \
                Dagger leave the battlefield.",
                &[
