...
/// Earthbending installs an independent listener for the exact land. Removing
/// its abilities does not remove the delayed return, and another zone change
/// cannot make that listener follow a different incarnation.
const fn earthbend<const N: i32>() -> EffectDef {
    EffectDef::BindObjects(BindObjectsDef {
                ...
                otherwise: &EffectDef::Sequence(&[
                    EffectDef::Apply {
                        ...
                        effect: AppliedEffectDef::Composite(&[
                            AppliedEffectDef::add_card_types(
                                CardTypeSet::single(CardType::Land).with(CardType::Creature),
                            ),
                    ...
                    EffectDef::AddCounters {
                        object: EffectRecipientDef::objects(ObjectSetDef::Binding(
                            crate::Binding!("earthbent"),
                        )),
                        kind: CounterKind::PlusOnePlusOne,
                        amount: ValueDef::Constant(N),
                    },
                                    ...
                                    effect: &const {
                                        EffectDef::move_to_zone(
                                            EffectRecipientDef::object(
                                                ObjectRefDef::ZoneChangeSuccessor(
                                                    ZoneChangeReferenceDef::TriggeringObject,
                                                ),
                                            ),
