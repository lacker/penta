...
// Audit: unsupported — Resolved durations can follow the source remaining on the battlefield,
// but cannot end when its controller changes. The first chapter's animation must end as soon as
// you no longer control this Saga, even if the Saga remains and later returns to your control.
pub(in crate::card::sets) static WELCOME_TO_JURASSIC_PARK: CardRecord = CardRecord::new(
...
// Audit: unsupported — The cast planner has no granted prowl alternative cost conditioned on
// combat damage by a creature sharing any of the candidate spell's creature types.
pub(in crate::card::sets) static HUNTING_VELOCIRAPTOR: CardRecord = CardRecord::new(
...
// REX 32 — Savage Order
pub(in crate::card::sets) static SAVAGE_ORDER: CardRecord = CardRecord::new(
    "Savage Order",
    ...
    CardRules::new_sorcery(mana_cost!("{2}{G}{G}")).with_ability(
        AbilityDef::spell_with_additional_cost(
            "As an additional cost to cast this spell, sacrifice a \
             ...
             a Dinosaur creature card, put it onto the battlefield, then \
            ...
            EffectDef::Choose(ChooseDef {
                ...
                minimum: 0,
                maximum: 1,
                binding: ObjectChoiceBindingDef::Objects(Binding!("ordered_dinosaur")),
                unchosen: None,
                ...
                then: &EffectDef::WithZoneMoveResult {
                    ...
                    binding: Binding!("ordered_arrival"),
...
pub(in crate::card::sets) static PERMISSION_DENIED: CardRecord = CardRecord::new(
    "Permission Denied",
