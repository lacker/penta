    ...
    CardRules::new_instant(mana_cost!("{1}{U}")).with_abilities(&[AbilityDef::spell_with_targets(
        ...
        EffectDef::IfElseCondition {
            ...
            then: &EffectDef::Sequence(&[
                ...
                EffectDef::create_token(tokens::map()).with_count(ValueDef::Constant(1)),
            ]),
...
pub(in crate::card::sets) static SYNAPSE_NECROMAGE: CardRecord = CardRecord::new(
    ...
    CardRules::new_creature(mana_cost!("{2}{B}"), &["Fungus", "Wizard"], 3, 1).with_abilities(&[
        abilities::dies_trigger(
            ...
            EffectDef::create_creature_token(&["Fungus"], &[ManaColor::Black], 1, 1)
        ...
        CardRules::new_sorcery(mana_cost!("{G}"))
            ...
            .with_ability(
                AbilityDef::spell(
                    ...
                    EffectDef::create_token(tokens::map()).with_count(ValueDef::Sum(
                        &const {
                            SumValueDef::new(
                                ValueDef::Constant(1),
    ...
    CardRules::new_creature(mana_cost!("{3}{R}{G}"), &["Dinosaur"], 5, 3).with_abilities(&[
        ...
        abilities::enters_trigger(
            "When this creature enters, create two 0/1 green Dinosaur Egg \
             creature tokens.",
            EffectDef::create_creature_token(&["Dinosaur", "Egg"], &[ManaColor::Green], 0, 1)
                .with_count(ValueDef::Constant(2)),
        ),
        AbilityDef::triggered_if(
            ...
            EffectDef::Sequence(&[
                ...
                EffectDef::create_creature_token(&["Dinosaur"], &[ManaColor::Red], 3, 1),
            ]),
        ),
    ]),
);
