...
pub(in crate::card::sets) static COUNCIL_OF_REEDS: CardRecord = CardRecord::new(
    ...
    "Vlad Petruchik",
    CardRules::new_creature(mana_cost!("{2}{U}"), &["Human", "Scientist", "Hero"], 2, 2)
        ...
        .with_abilities(&[
            ...
            AbilityDef::triggered_if(
                "At the beginning of combat on your turn, if you've cast a \
                 noncreature spell this turn, create a token that's a copy \
                 of Council of Reeds.",
...
pub(in crate::card::sets) static LOKI_S_SCEPTER: CardRecord = CardRecord::new(
    "Loki's Scepter",
    ...
    CardRules::new_artifact(mana_cost!("{2}{R}"))
        ...
        .with_abilities(&[
            abilities::enters_trigger_with_targets(
                "When Loki's Scepter enters, gain control of target creature \
                 until end of turn. Untap that creature. Until end of turn, \
                 it becomes a Villain in addition to its other types and \
                 gains haste.",
                    ...
                    EffectDef::Apply {
                        ...
                        effect: AppliedEffectDef::Composite(&[
                            AppliedEffectDef::Characteristic(CharacteristicOperationDef::Subtypes(
                                SetOperationDef::Add(crate::card::SubtypeSet::from_names(&[
                                    "Villain",
                                ])),
                            )),
...
pub(in crate::card::sets) static H_E_R_B_I_E_LOVABLE_ROBOT: CardRecord = CardRecord::new(
    "H.E.R.B.I.E., Lovable Robot",
    "5e2f9f4c-dbdd-4da6-b08f-1f4d3fcb1328",
    "Nanna Marie Steffensen",
    CardRules::new_artifact_creature(mana_cost!("{2}"), &["Robot", "Scout"], 1, 1)
        .with_supertype(CardSupertype::Legendary)
        .with_abilities(&[
            abilities::flying(),
            AbilityDef::triggered_if(
                "At the beginning of combat on your turn, if you've cast a \
                 noncreature spell this turn, surveil 1.",
                TriggerEventDef::StepBegins {
                    step: TurnStepDef::BeginningOfCombat,
                    player: PlayerRelation::You,
                },
...
pub(in crate::card::sets) static BLACK_WIDOW_AGILE_AVENGER: CardRecord = CardRecord::new(
    "Black Widow, Agile Avenger",
    "0b165b56-ad86-4d8c-91e2-1464b2ac5c6d",
    "Junggeun Yoon",
    CardRules::new_creature(mana_cost!("{1}{R}{W}"), &["Human", "Spy", "Hero"], 2, 2)
        .with_supertype(CardSupertype::Legendary)
        .with_abilities(&[
            abilities::menace(),
            AbilityDef::triggered(
                "Whenever an opponent draws their second card each turn, put \
                 a +1/+1 counter on Black Widow and you draw a card.",
...
pub(in crate::card::sets) static MATT_MURDOCK_JUSTICE_SEEKER: CardRecord = CardRecord::new(
...
pub(in crate::card::sets) static DOCTOR_DOOM_UNRIVALED: CardRecord = CardRecord::new(
    "Doctor Doom, Unrivaled",
    "2973e855-fe93-41a1-a62e-4699ef2c3d1d",
    "Vilhelmas Banys",
    CardRules::new_creature(
        mana_cost!("{2}{B}{B}"),
        &["Human", "Sorcerer", "Villain"],
        4,
        4,
    )
    .with_supertype(CardSupertype::Legendary)
    .with_abilities(&[
        ...
        AbilityDef::activated(
            "{T}: You draw a card and lose 1 life. Then if your library \
             has no cards in it, you win the game. (You win even if you \
             have 0 life or didn't draw a card.)",
            &[CostDef::TapSource],
            EffectDef::Sequence(&[
                abilities::draw_cards(ValueDef::Constant(1)),
                EffectDef::LoseLife {
...
// Audit: unsupported — DamageKindDef distinguishes combat from any damage, but cannot match
// only noncombat damage for the graveyard return trigger.
pub(in crate::card::sets) static ASGARDIAN_INSPIRATION: CardRecord = CardRecord::new(
...
pub(in crate::card::sets) static THE_VISION_AND_SCARLET_WITCH: CardRecord = CardRecord::new(
    "The Vision and Scarlet Witch",
    "930afb5f-54b7-4cca-8c28-3e48938f3a43",
    "Tyler Walpole",
    CardRules::new_artifact_creature(mana_cost!("{2}{R}{R}"), &["Mutant", "Hero"], 3, 3)
        .with_supertype(CardSupertype::Legendary)
        .with_abilities(&[
            abilities::flying(),
            AbilityDef::triggered(
                "Whenever you cast a spell, add {R} and put a +1/+1 counter \
                 on The Vision and Scarlet Witch.",
...
pub(in crate::card::sets) static DEVIL_DINOSAUR: CardRecord = CardRecord::new(
    "Devil Dinosaur",
    "fcb4c268-441f-41cf-8c25-538eefc6a710",
    "Wero Gallo",
    CardRules::new_creature(mana_cost!("{2}{G}{G}"), &["Dinosaur"], 5, 5)
        .with_supertype(CardSupertype::Legendary)
        .with_abilities(&[
            abilities::trample(),
            AbilityDef::static_ability(
                "Other Dinosaurs you control get +1/+1 and have hexproof. \
                 (They can't be the targets of spells or abilities your \
                 opponents control.)",
                EffectDef::StaticApply {
...
pub(in crate::card::sets) static FOGWELL_S_GYM: CardRecord = CardRecord::new(
    "Fogwell's Gym",
...
pub(in crate::card::sets) static CARDS: &[&CardRecord] = &[
    ...
    &BLACK_WIDOW_AGILE_AVENGER,
    &MATT_MURDOCK_JUSTICE_SEEKER,
    &DOCTOR_DOOM_UNRIVALED,
    &ASGARDIAN_INSPIRATION,
    &THE_VISION_AND_SCARLET_WITCH,
    &DEVIL_DINOSAUR,
    &FOGWELL_S_GYM,
];
