...
#[must_use]
pub const fn cumulative_upkeep(cost: CumulativeUpkeepCostDef) -> AbilityDef {
    let text = match cost {
        CumulativeUpkeepCostDef::Mana(cost) if mana_cost_is_generic(cost, 1) => {
            "Cumulative upkeep {1} (At the beginning of your upkeep, put an age counter on this permanent, then sacrifice it unless you pay its upkeep cost for each age counter on it.)"
        }
        CumulativeUpkeepCostDef::Mana(cost) if mana_cost_is_generic(cost, 2) => {
            "Cumulative upkeep {2} (At the beginning of your upkeep, put an age counter on this permanent, then sacrifice it unless you pay its upkeep cost for each age counter on it.)"
        }
        CumulativeUpkeepCostDef::Mana(cost) if mana_cost_is_green(cost, 1) => {
        ...
        CumulativeUpkeepCostDef::Life(1) => {
        ...
        CumulativeUpkeepCostDef::Life(2) => {
        ...
        CumulativeUpkeepCostDef::DrawCards(1) => {
        ...
        CumulativeUpkeepCostDef::PutCounters {
