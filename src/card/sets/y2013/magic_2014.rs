...
use crate::card::{
    ...
    CardSupertype, CardType, CardTypeSet, CastTimingPermissionDef, ChoiceVisibilityDef, ChooseDef,
    ClassifyObjectsDef, ColorChoiceOperationDef, ColorSet, ComparisonDef, CostDef, CounterKind,
