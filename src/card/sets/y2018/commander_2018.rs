...
pub(in crate::card::sets) static LOYAL_APPRENTICE: CardRecord = CardRecord::new(
    "Loyal Apprentice",
    ...
    CardRules::new_creature(mana_cost!("{1}{R}"), &["Human", "Artificer"], 2, 1).with_abilities(&[
        ...
        AbilityDef::triggered_if(
            "Lieutenant — At the beginning of combat on your turn, if \
             you control your commander, create a 1/1 colorless Thopter \
             artifact creature token with flying. That token gains haste \
             until end of turn.",
...
pub(in crate::card::sets) static ARIXMETHES_SLUMBERING_ISLE: CardRecord = CardRecord::new(
    "Arixmethes, Slumbering Isle",
    "c723c7dc-a452-49ec-a4e5-9e516fe530e9",
    "Dimitar Marinski",
    CardRules::new_creature(mana_cost!("{2}{G}{U}"), &["Kraken"], 12, 12)
        ...
        .with_abilities(&[
                ...
                ReplacementEffectDef::Sequence(&[
                    ...
                    ReplacementEffectDef::ModifyBattlefieldEntry(
                        BattlefieldEntryModificationDef::AddCounters {
                            kind: CounterKind::named("slumber"),
                            amount: 5,
                        },
                    ),
                ]),
            ...
            AbilityDef::static_ability(
                "As long as Arixmethes has a slumber counter on it, it's a \
                 land. (It's not a creature.)",
            ...
            AbilityDef::triggered(
                ...
                EffectDef::May {
                    ...
                    effect: &EffectDef::RemoveCounters {
            ...
            abilities::tap_for_mana(
                "{T}: Add {G}{U}.",
                AddManaEffectDef::one_of_each(ManaColor::Green, ManaColor::Blue),
            ),
        ]),
);
    ...
    CardRules::new_artifact(mana_cost!("{6}")).with_abilities(&[
        ...
        AbilityDef::triggered(
            "Whenever one or more creatures an opponent controls attack \
             you and aren't blocked, that player draws three cards and \
...
pub(in crate::card::sets) static ENDLESS_ATLAS: CardRecord = CardRecord::new(
    ...
    CardRules::new_artifact(mana_cost!("{2}")).with_ability(
        AbilityDef::activated(
            "{2}, {T}: Draw a card. Activate only if you control three \
             or more lands with the same name.",
