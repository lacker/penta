...
// Audit: unsupported — Needs a selected discard as a mana-ability cost. Nonmana activations and resolving payments support CostDef::Discard, but the mana path does not yet plan and commit that selection.
