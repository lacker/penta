...
pub(in crate::card::sets) static EAGLES_OF_THE_NORTH: CardRecord = CardRecord::new(
    ...
    CardRules::new_creature(mana_cost!("{5}{W}"), &["Bird", "Soldier"], 3, 3).with_abilities(&[
        abilities::flying(),
...
pub(in crate::card::sets) static FLOWERING_OF_THE_WHITE_TREE: CardRecord = CardRecord::new(
...
// Audit: unsupported — The Ring tempting procedure, persistent Ring-bearer designation, and
// advancing Ring abilities have no runtime representation.
pub(in crate::card::sets) static SAMWISE_THE_STOUTHEARTED: CardRecord = CardRecord::new(
...
pub(in crate::card::sets) static IORETH_OF_THE_HEALING_HOUSE: CardRecord = CardRecord::new(
...
pub(in crate::card::sets) static LORIEN_REVEALED: CardRecord = CardRecord::new(
    ...
    CardRules::new_sorcery(mana_cost!("{3}{U}{U}")).with_abilities(&[
        ...
        abilities::typecycling!(
            "Islandcycling {1} ({1}, Discard this card: Search your \
...
pub(in crate::card::sets) static ORCISH_BOWMASTERS: CardRecord = CardRecord::new(
    ...
    CardRules::new_creature(mana_cost!("{1}{B}"), &["Orc", "Archer"], 1, 1).with_abilities(&[
        abilities::flash(),
        AbilityDef::triggered_with_targets(
            "When this creature enters and whenever an opponent draws a \
             card except the first one they draw in each of their draw \
             steps, this creature deals 1 damage to any target. Then \
             amass Orcs 1.",
            ...
            EffectDef::Sequence(&[
                ...
                EffectDef::IfCondition {
                    ...
                    then: &EffectDef::CreateToken(CreateTokenDef::new(TokenDef::Literal(
                        TokenCharacteristics::creature(&["Orc", "Army"], &[ManaColor::Black], 0, 0)
...
pub(in crate::card::sets) static TROLL_OF_KHAZAD_DUM: CardRecord = CardRecord::new(
    ...
    CardRules::new_creature(mana_cost!("{5}{B}"), &["Troll"], 6, 5).with_abilities(&[
        ...
        abilities::typecycling!(
            "Swampcycling {1} ({1}, Discard this card: Search your \
...
pub(in crate::card::sets) static EOMER_MARSHAL_OF_ROHAN: CardRecord = CardRecord::new(
    "Éomer, Marshal of Rohan",
    "0bd31ce9-9551-4efe-8bd2-b97d8efbf75e",
    "Jesper Ejsing",
    CardRules::new_creature(mana_cost!("{2}{R}{R}"), &["Human", "Knight"], 4, 4)
        .with_supertype(CardSupertype::Legendary)
        .with_abilities(&[
            abilities::haste(),
            AbilityDef::triggered(
                "Whenever one or more other attacking legendary creatures \
                 you control die, untap all creatures you control. After \
                 this phase, there is an additional combat phase. This \
...
pub(in crate::card::sets) static OLIPHAUNT: CardRecord = CardRecord::new(
    ...
    CardRules::new_creature(mana_cost!("{5}{R}"), &["Elephant"], 6, 4).with_abilities(&[
        ...
        abilities::typecycling!(
            "Mountaincycling {1} ({1}, Discard this card: Search your \
...
pub(in crate::card::sets) static GENEROUS_ENT: CardRecord = CardRecord::new(
    ...
    CardRules::new_creature(mana_cost!("{5}{G}"), &["Treefolk"], 5, 7).with_abilities(&[
        ...
        abilities::typecycling!(
            "Forestcycling {1} ({1}, Discard this card: Search your \
...
pub(in crate::card::sets) static ARWEN_MORTAL_QUEEN: CardRecord = CardRecord::new(
    ...
    CardRules::new_creature(mana_cost!("{1}{G}{W}"), &["Elf", "Noble"], 2, 2)
        ...
        .with_abilities(&[
            ...
            AbilityDef::activated_with_targets(
                "{1}, Remove an indestructible counter from Arwen: Another \
                 target creature gains indestructible until end of turn. Put \
                 a +1/+1 counter and a lifelink counter on that creature and \
                 a +1/+1 counter and a lifelink counter on Arwen.",
                &[
                    CostDef::Mana(mana_cost!("{1}")),
...
pub(in crate::card::sets) static FLAME_OF_ANOR: CardRecord = CardRecord::new(
    ...
    CardRules::new_instant(mana_cost!("{1}{U}{R}")).with_ability(
        AbilityDef::modal_spell(
            "Choose one. If you control a Wizard as you cast this spell, \
             you may choose two instead.",
            &[
...
pub(in crate::card::sets) static SAURON_S_RANSOM: CardRecord = CardRecord::new(
    "Sauron's Ransom",
...
pub(in crate::card::sets) static MITHRIL_COAT: CardRecord = CardRecord::new(
    "Mithril Coat",
    ...
    CardRules::new_artifact(mana_cost!("{4}"))
        ...
        .with_abilities(&[
            ...
            AbilityDef::triggered_if(
                "When this artifact enters, if you cast it, you gain \
            ...
            AbilityDef::activated(
                "{T}: Put a burden counter on this artifact, then draw a \
...
// Audit: unsupported — The equipment needs a live conditional first-strike ability evaluated in
// the equipped creature's source scope. Granted executable static abilities are rejected, and
// the existing blocker predicates are relative to the Equipment rather than its host.
pub(in crate::card::sets) static STING_THE_GLINTING_DAGGER: CardRecord = CardRecord::new(
...
pub(in crate::card::sets) static GREAT_HALL_OF_THE_CITADEL: CardRecord = CardRecord::new(
    ...
    CardRules::new_land(&[]).with_abilities(&[
        abilities::tap_for(ManaColor::Colorless),
        AbilityDef::activated_mana(
            "{1}, {T}: Add two mana in any combination of colors. Spend \
             this mana only to cast legendary spells.",
...
pub(in crate::card::sets) static MINAS_TIRITH: CardRecord = CardRecord::new(
    "Minas Tirith",
...
pub(in crate::card::sets) static MINES_OF_MORIA: CardRecord = CardRecord::new(
    "Mines of Moria",
...
// LTR 258 — Mount Doom
pub(in crate::card::sets) static MOUNT_DOOM: CardRecord = CardRecord::new(
    "Mount Doom",
    ...
    CardRules::new_land(&[])
        ...
        .with_abilities(&[
            ...
            AbilityDef::activated(
                ...
                &[CostDef::Mana(mana_cost!("{1}{B}{R}")), CostDef::TapSource],
                EffectDef::damage(EffectRecipientDef::Opponent, ValueDef::Constant(1)),
            ),
            AbilityDef::activated(
                "{5}{B}{R}, {T}, Sacrifice Mount Doom and a legendary \
                 artifact: Choose up to two creatures, then destroy the \
                 rest. Activate only as a sorcery.",
                &[
                    CostDef::Mana(mana_cost!("{5}{B}{R}")),
                    CostDef::TapSource,
                ...
                EffectDef::Choose(ChooseDef {
                    ...
                    minimum: 0,
                    maximum: 2,
                    binding: ObjectChoiceBindingDef::Objects(Binding!("doom_saved")),
                    unchosen: Some(Binding!("doom_destroyed")),
...
pub(in crate::card::sets) static GANDALF_THE_WHITE: CardRecord = CardRecord::new(
    "Gandalf the White",
...
// LTR 344 — Rivendell
pub(in crate::card::sets) static RIVENDELL: CardRecord = CardRecord::new(
    "Rivendell",
...
pub(in crate::card::sets) static BORNE_UPON_A_WIND: CardRecord = CardRecord::new(
    "Borne Upon a Wind",
...
pub(in crate::card::sets) static GLOIN_DWARF_EMISSARY: CardRecord =
    CardRecord::new(
        "Glóin, Dwarf Emissary",
        "6d74d1af-5cc6-422e-949c-de9e39b76154",
        "Tomas Duchek",
        CardRules::new_creature(mana_cost!("{2}{R}"), &["Dwarf", "Advisor"], 3, 3)
            .with_supertype(CardSupertype::Legendary)
            .with_abilities(&[
                AbilityDef::triggered(
                    "Whenever you cast a historic spell, create a Treasure \
                ...
                .triggering_at_most(1),
                AbilityDef::activated_with_targets(
                    "{T}, Sacrifice a Treasure: Goad target creature. (Until \
                     your next turn, that creature attacks each combat if able \
...
pub(in crate::card::sets) static MORIA_MARAUDER: CardRecord = CardRecord::new(
    "Moria Marauder",
...
pub(in crate::card::sets) static LOTHO_CORRUPT_SHIRRIFF: CardRecord = CardRecord::new(
    "Lotho, Corrupt Shirriff",
    "69d97af0-8af0-4124-b56f-2633d34e5574",
    "Ilker Yildiz",
    CardRules::new_creature(mana_cost!("{W}{B}"), &["Halfling", "Rogue"], 2, 1)
        .with_supertype(CardSupertype::Legendary)
        .with_abilities(&[AbilityDef::triggered(
            "Whenever a player casts their second spell each turn, you \
             lose 1 life and create a Treasure token. (It's an artifact \
...
// Audit: unsupported — The Ring tempting procedure, persistent Ring-bearer designation, and
// advancing Ring abilities have no runtime representation.
pub(in crate::card::sets) static BOROMIR_WARDEN_OF_THE_TOWER: CardRecord = CardRecord::new(
...
pub(in crate::card::sets) static LAST_MARCH_OF_THE_ENTS: CardRecord = CardRecord::new(
    ...
    CardRules::new_sorcery(mana_cost!("{6}{G}{G}")).with_abilities(&[
        ...
        AbilityDef::spell(
            "Draw cards equal to the greatest toughness among creatures \
             you control, then put any number of creature cards from \
             your hand onto the battlefield.",
            EffectDef::Sequence(&[
                abilities::draw_cards(ValueDef::AggregateObjectValues(&ObjectValueAggregateDef {
                ...
                EffectDef::Choose(ChooseDef {
                    ...
                    minimum: 0,
                    maximum: 255,
                    binding: ObjectChoiceBindingDef::Objects(Binding!("ents_creatures")),
                    unchosen: None,
                    visibility: ChoiceVisibilityDef::Private,
...
pub(in crate::card::sets) static MERRY_ESQUIRE_OF_ROHAN: CardRecord = CardRecord::new(
...
// Audit: unsupported — Mana-selection domains cannot take the union of colors of queried
// legendary creature cards in a graveyard. CouldBeProducedBy inspects mana abilities, not card
// colors.
pub(in crate::card::sets) static THE_GREY_HAVENS: CardRecord = CardRecord::new(
    "The Grey Havens",
...
pub(in crate::card::sets) static CARDS: &[&CardRecord] = &[
    &EAGLES_OF_THE_NORTH,
    &FLOWERING_OF_THE_WHITE_TREE,
    &REPRIEVE,
    &SAMWISE_THE_STOUTHEARTED,
    &IORETH_OF_THE_HEALING_HOUSE,
    &LORIEN_REVEALED,
    &STERN_SCOLDING,
    &ORCISH_BOWMASTERS,
    &TROLL_OF_KHAZAD_DUM,
    ...
    &MITHRIL_COAT,
    &THE_ONE_RING,
    &STING_THE_GLINTING_DAGGER,
    &GREAT_HALL_OF_THE_CITADEL,
    &MINAS_TIRITH,
    &MINES_OF_MORIA,
    &MOUNT_DOOM,
    &GANDALF_THE_WHITE,
    &RIVENDELL,
    &BORNE_UPON_A_WIND,
    &GLOIN_DWARF_EMISSARY,
    &MORIA_MARAUDER,
    &LOTHO_CORRUPT_SHIRRIFF,
    &BOROMIR_WARDEN_OF_THE_TOWER,
    &LAST_MARCH_OF_THE_ENTS,
    &MERRY_ESQUIRE_OF_ROHAN,
    &THE_GREY_HAVENS,
];
