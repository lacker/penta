...
// Audit: unsupported — Random discard cannot run a follow-up counting the cards actually
// discarded; selecting a random card and moving it would lose discard replacement and
// prevention semantics.
pub(in crate::card::sets) static RECKLESS_HANDLING: CardRecord = CardRecord::new(
    "Reckless Handling",
...
pub(in crate::card::sets) static TRANQUIL_FRILLBACK: CardRecord = CardRecord::new(
    "Tranquil Frillback",
...
pub(in crate::card::sets) static OB_NIXILIS_CAPTIVE_KINGPIN: CardRecord = CardRecord::new(
...
pub(in crate::card::sets) static SAMUT_VIZIER_OF_NAKTAMUN: CardRecord = CardRecord::new(
    "Samut, Vizier of Naktamun",
    "30c3f755-d70d-46d7-80dd-428ca1a355c4",
    "Jarel Threat",
    CardRules::new_creature(
        mana_cost!("{1}{R}{G}"),
        &["Human", "Warrior", "Cleric"],
        2,
        3,
    )
...
pub(in crate::card::sets) static CARDS: &[&CardRecord] = &[
    &RECKLESS_HANDLING,
    &TRANQUIL_FRILLBACK,
    &OB_NIXILIS_CAPTIVE_KINGPIN,
    &SAMUT_VIZIER_OF_NAKTAMUN,
];
