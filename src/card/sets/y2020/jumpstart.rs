...
pub(in crate::card::sets) static EMIEL_THE_BLESSED: CardRecord = CardRecord::new(
    "Emiel the Blessed",
    "f74dfd07-d17c-4890-82c3-4b12a6029940",
    "Antonio José Manzanedo",
    CardRules::new_creature(mana_cost!("{2}{W}{W}"), &["Unicorn"], 4, 4)
        .with_supertype(CardSupertype::Legendary)
        .with_abilities(&[
            AbilityDef::activated_with_targets(
                "{3}: Exile another target creature you control, then return \
            ...
            AbilityDef::triggered(
                "Whenever another creature you control enters, you may pay \
                 {G/W}. If you do, put a +1/+1 counter on it. If it's a \
                 Unicorn, put two +1/+1 counters on it instead. ({G/W} can \
                 be paid with either {G} or {W}.)",
...
pub(in crate::card::sets) static MUXUS_GOBLIN_GRANDEE: CardRecord = CardRecord::new(
    "Muxus, Goblin Grandee",
    "2c716d10-2130-43b7-a939-349d437e1091",
    "Dmitry Burmak",
    CardRules::new_creature(mana_cost!("{4}{R}{R}"), &["Goblin", "Noble"], 4, 4)
        .with_supertype(CardSupertype::Legendary)
        .with_abilities(&[
            abilities::enters_trigger(
                "When Muxus enters, reveal the top six cards of your \
                 library. Put all Goblin creature cards with mana value 5 or \
                 less from among them onto the battlefield and the rest on \
                ...
                EffectDef::RevealAndClassifyCards(RevealAndClassifyCardsDef {
                    ...
                    then: &EffectDef::Sequence(&[
                        ...
                        EffectDef::RandomizeObjectOrder(RandomizeObjectOrderDef {
                            input: ObjectSetDef::Binding(Binding!("remainder")),
                            randomized: Binding!("random_bottom"),
                            then: &EffectDef::MoveObjects(MoveObjectsDef {
                                input: ObjectSetDef::Binding(Binding!("random_bottom")),
            ...
            AbilityDef::triggered(
                "Whenever Muxus attacks, it gets +1/+1 until end of turn for \
                 each other Goblin you control.",
...
pub(in crate::card::sets) static ALLOSAURUS_SHEPHERD: CardRecord = CardRecord::new(
    "Allosaurus Shepherd",
    ...
    CardRules::new_creature(mana_cost!("{G}"), &["Elf", "Shaman"], 1, 1).with_abilities(&[
        ...
        AbilityDef::activated(
            "{4}{G}{G}: Until end of turn, each Elf creature you control \
            ...
            EffectDef::Apply {
                ...
                effect: AppliedEffectDef::Composite(&[
                    ...
                    AppliedEffectDef::Characteristic(CharacteristicOperationDef::CreatureTypes(
                        SetOperationDef::Add(CreatureTypeSetDef::named(&["Dinosaur"])),
                    )),
                ]),
                duration: ResolvedEffectDurationDef::UntilEndOfTurn,
            },
