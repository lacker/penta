...
pub(in crate::card::sets) static SAVAGE_THALLID: CardRecord = CardRecord::new(
    ...
    CardRules::new_creature(mana_cost!("{3}{G}{G}"), &["Fungus"], 5, 2).with_abilities(&[
        ...
        AbilityDef::activated_with_targets(
            ...
            &[AbilityTargetDef::exactly_one(
                AbilityTargetPredicate::Object {
                    object: ObjectPredicateDef::Subtype("Fungus"),
                    zones: &[ZoneKind::Battlefield],
                    controller: None,
                    owner: None,
                },
    ...
    CardRules::new_land(&[]).with_abilities(&[
        ...
        AbilityDef::activated_with_targets(
            ...
            &[AbilityTargetDef::exactly_one(
                AbilityTargetPredicate::Object {
                    object: ObjectPredicateDef::AnyOf(&[
                        ObjectPredicateDef::Subtype("Insect"),
                        ObjectPredicateDef::Subtype("Rat"),
                        ObjectPredicateDef::Subtype("Spider"),
