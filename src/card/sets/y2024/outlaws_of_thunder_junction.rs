...
// OTJ 93 — Lively Dirge
// Audit: unsupported — Needs a nontargeted up-to-two card choice constrained by the combined mana value of the entire selected group; Choose supports cardinality and per-object predicates, not an aggregate upper bound.
