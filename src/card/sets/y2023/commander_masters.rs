...
// Audit: unsupported — Needs encore, including a graveyard-granted variable-cost ability and
// its attacking token copies with delayed sacrifice.
...
pub(in crate::card::sets) static SKITTERING_CICADA: CardRecord = CardRecord::new(
    "Skittering Cicada",
        ...
        AbilityDef::static_ability(
            ...
            EffectDef::StaticApply {
                ...
                effect: AppliedEffectDef::Rule(AppliedRuleDef::MayCastAsThoughItHadFlash(
                    CastTimingPermissionDef::new(ObjectPredicateDef::ColorCount(0)),
                )),
            },
        ),
        AbilityDef::triggered(
            "Whenever you cast a colorless spell, until end of turn, \
             this creature gains trample and gets +X/+X, where X is that \
             spell's mana value.",
...
pub(in crate::card::sets) static CARDS: &[&CardRecord] = &[&SLIVER_GRAVEMOTHER, &SKITTERING_CICADA];
